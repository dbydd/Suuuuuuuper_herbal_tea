...
public class HoneySuckleBlock extends BushBlock {
    public HoneySuckleBlock(Properties properties) {
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
        if (!worldIn.isRemote()) {
            ItemEntity itemEntity = new ItemEntity(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(RegisteredItems.HONEY_SUCKLE_ITEM));
