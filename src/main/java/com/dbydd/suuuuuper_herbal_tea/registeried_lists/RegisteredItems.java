...
public class RegisteredItems {
    ...
    public static final Item BIG_BLACK_POT_ITEM = new BigBlackPotItem();
    public static final Item TEA_CUP = new TeaCupItem();
    public static final Item SPOON = new BigSpoon();
    public static final Item MOUNTAIN_TEA_LEAVE = new TeaLeaves("mountain_tea_leave", (world, playerEntity, magnification) -> {
    ...
    public static final Item PLAIN_TEA_LEAVE = new TeaLeaves("plain_tea_leave", (world, playerEntity, magnification) -> {
    ...
    public static final Item OCEAN_TEA_LEAVE = new TeaLeaves("ocean_tea_leave", (world, playerEntity, magnification) -> {
    ...
    public static final Item JUNGLE_TEA_LEAVE = new TeaLeaves("jungle_tea_leave", (world, playerEntity, magnification) -> {
    ...
    public static final Item DESERT_TEA_LEAVE = new TeaLeaves("desert_tea_leave", (world, playerEntity, magnification) -> {
//        world.setBlockState(playerEntity.getPosition(), Blocks.WATER.getDefaultState(), 2);
    }, new EffectInstance(Effects.LUCK, 100, 2));
    public static final Item TROPICAL_TEA_LEAVE = new TeaLeaves("tropical_tea_leave", (world, playerEntity, magnification) -> {
    ...
    public static final Item CLAY_TEA_LEAVE = new TeaLeaves("clay_tea_leave", (world, playerEntity, magnification) -> {
    ...
    public static final Item SNOW_TEA_LEAVE = new TeaLeaves("snow_land_tea_leave", (world, playerEntity, magnification) -> {
    ...
    public static final Item SWAMP_TEA_LEAVE = new TeaLeaves("swamp_tea_leave", (world, playerEntity, magnification) -> {
    ...
    public static final Item WORLD_TEA_TREE_TEA_LEAVE = new TeaLeaves("world_tea_tree_tea_leave", (world, playerEntity, magnification) -> {
    ...
    public static final Item HONEY_SUCKLE_ITEM = new HoneySuckleItem((world, playerEntity, magnification) -> {
        World world1 = world.getWorld();
        if (!world.isRemote()) {
            WorldInfo worldInfo = world1.getWorldInfo();
            if (worldInfo.isRaining()) {
