...
public class FluidBase {
    private static DeferredRegister<Fluid> FLUID_REGISTER = SuuuuuuuperHerbalTea.FLUID_REGISTER;
    private static DeferredRegister<Block> BLOCK_REGISTER = SuuuuuuuperHerbalTea.BLOCK_REGISTER;
    private static DeferredRegister<Item> ITEM_REGISTER = SuuuuuuuperHerbalTea.ITEM_REGISTER;
    ...
    public FluidBase(String name, Block.Properties fluid_block_properties, Function<FluidAttributes.Builder, FluidAttributes.Builder> factory) {
