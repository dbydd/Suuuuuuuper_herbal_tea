...
public class TeaResourceGenPlacement extends Placement<NoPlacementConfig> {
    public TeaResourceGenPlacement(Function<Dynamic<?>, ? extends NoPlacementConfig> configFactoryIn) {
