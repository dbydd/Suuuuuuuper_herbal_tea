...
public class Tea_Villa_Resource_Gen_Placement extends Placement<NoPlacementConfig> {
    public Tea_Villa_Resource_Gen_Placement(Function<Dynamic<?>, ? extends NoPlacementConfig> configFactoryIn) {
