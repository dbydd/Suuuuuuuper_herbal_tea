...
public class Tea_Villa_Resource_GenFeature extends FlowersFeature<BlockClusterFeatureConfig> {

    public Tea_Villa_Resource_GenFeature(Function<Dynamic<?>, ? extends BlockClusterFeatureConfig> p_i49876_1_) {
        super(p_i49876_1_);
    }
