...
public class WorldTeaTreeFruitParticleData implements IParticleData {
    public static final IDeserializer<WorldTeaTreeFruitParticleData> DESERIALIZER = new IDeserializer<WorldTeaTreeFruitParticleData>() {

        @Override
        public WorldTeaTreeFruitParticleData deserialize(ParticleType<WorldTeaTreeFruitParticleData> particleTypeIn, StringReader reader) throws CommandSyntaxException {
            ...
            return new WorldTeaTreeFruitParticleData(new Vec3d(speedX, speedY, speedZ), new Color(red, green, blue, alpha), diameter);
        }

        @Override
        public WorldTeaTreeFruitParticleData read(ParticleType<WorldTeaTreeFruitParticleData> particleTypeIn, PacketBuffer buffer) {
            final int MIN_COLOUR = 0;
            final int MAX_COLOUR = 255;
    ...
    public WorldTeaTreeFruitParticleData(Vec3d vec3d, Color color, float diameter) {
        this.speed = vec3d;
        this.color = color;
    ...
    public ParticleType<?> getType() {
        return RegisteredParticleTypes.WORLD_TEA_TREE_FRUIT_PARTICLETYPE.get();
    }
